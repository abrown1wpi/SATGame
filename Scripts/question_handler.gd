...
var question_data_path = "res://Data/gamespread.json"
...
func parse_question_data(_id, json_data : Dictionary):
	...
	question_data.answer = json_data["C_ANSWER"]
	question_data.question = json_data["QUESTION"]
	
	question_data.incorrect_answers = [json_data["ANSWER_1"], json_data["ANSWER_2"], json_data["ANSWER_3"]]
